...
- Do not send update and do not notify user unless there is an order status change. 
- If order status indicates order is delivered, send a message to notify user of order arrival. 
- If order status indicated order is delayed, send a message to notify user of order delay.  
