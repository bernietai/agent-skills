...
Prefer checkout using Express Checkout with "Shopify Shop", "Paypal" or "Google Pay". If
Express Checkout is not available, do not proceed. 

## Green Rewards ##

Report on Green Rewards points balance and redemption options after checkout completion.
